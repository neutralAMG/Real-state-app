...
{
    public interface IBaseService< TSaveModel, TEntity, TId>
    ...
    public interface IBaseCompleteService<TModel, TSaveModel, TEntity, TId> : IBaseService< TSaveModel, TEntity, TId>
        where TModel : class
        where TSaveModel : class
        where TEntity : class
    {
